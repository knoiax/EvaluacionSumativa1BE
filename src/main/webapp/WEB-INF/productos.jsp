...
<form action="${pageContext.request.contextPath}/api/productos" method="POST" class="px-2">
	<div class="container col-md-12">
		<h3 style="text-align: center;">Productos</h3><br>
		<div class="row">
	    	<div class="col-md-6">	    
      		...
      		<div class="col-md-6">
			    ...
			    <div class="container">
			        <div class="row">
			            <div class="btn-group" role="group" aria-label="Basic mixed styles example">
			                <button type="submit" name="actualizarPrecio" class="btn btn-primary">Actualizar precio</button>
			            </div>
			        </div>
			    </div>
			    <hr>
			    <div class="form-group">
			        <label>id: </label>
			        <input type="text" class="form-control" name="id4">
			        <br>
			    </div>
			    <div class="form-group">
