...
<form action="${pageContext.request.contextPath}/api/ventas" method="POST" class="px-2">
	<div class="container col-md-12">
		<h3 style="text-align: center;">Ventas</h3><br>
		<div class="row">
	    	<div class="col-md-6">	    
      		...
      		<div class="col-md-6">
			    ...
			    <div class="form-group">
			        <label>Unidades: </label>
			        <input type="text" class="form-control" name="unidades2">
			        <br>
			    </div>
			    <div class="container">
			        <div class="row">
